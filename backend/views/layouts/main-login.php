...
<!-- end #page-loader -->
    ...
    <div class="login-cover">
        <div class="login-cover-image"><img src="../img/login-bg/bg-5.jpg" data-id="login-cover-image" alt="" /></div>
...
<!-- <ul class="login-bg-list clearfix">
            ...
            <li class="active"><a href="#" data-click="change-bg"><img src="../img/login-bg/bg-5.jpg" alt="" /></a></li>
